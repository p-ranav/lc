...
void LineCounter::count_lines_in_chunk(std::size_t chunk_index, std::size_t chunk_start,
...
std::size_t LineCounter::count() {
  ...
  for (std::size_t i = 0; i < num_chunks; ++i) {
    ...
    threads.push_back(std::thread(
        std::bind(&LineCounter::count_lines_in_chunk, this, i, chunk_start, chunk_end)));
  }
